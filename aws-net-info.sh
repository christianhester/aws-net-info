...
INPUTS:
    instance-id         EC2 instance ID (e.g., i-0ee2cfb1ebfb7f343)
    eni-id             Network interface ID (e.g., eni-02b540350d67953e7)
    ip-address         Public or private IP (e.g., 172.31.21.79 or 13.220.187.93)
    multiple-inputs    Comma-separated list (e.g., i-123,172.31.1.5,eni-abc)
...
EXAMPLES:
    ...
    $0 i-0ee2cfb1ebfb7f343

    # Query by IP address
    $0 172.31.21.79

    # Query with specific AWS profile
    $0 eni-02b540350d67953e7 prod-account

    # Query multiple resources at once
    $0 172.31.21.79,10.0.5.23,i-0ee2cfb1ebfb7f343

    # Query multiple with profile
    $0 i-123,172.31.1.5 dev-account
